...
tk=Tk()
lab=Label(text="Check your drowsiness heree click on the submit button",font=("Arial",10),foreground="red").place(x=100,y=100)
sub=Button(text="Detect",command=run).place(x=200,y=200,width=100,height=50)
tk.geometry('500x500')
tk.mainloop()